...
const amenities = [
  ...
  { icon: Zap, name: "Free Generator", description: "Uninterrupted power backup" },
  ...
  { icon: Car, name: "Free Parking", description: "Convenient vehicle parking" },
]
    ...
    <section className="py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-foreground/60 mb-12 max-w-2xl">
          Every detail is thoughtfully arranged for comfort, convenience, and a
          peaceful stay during your spiritual journey.
        </p>
            ...
            return (
              <div key={idx} className="group">
                <div className="bg-card border border-border rounded-xl p-6 h-full text-center hover:border-primary hover:bg-primary/5 transition-all hover:shadow-lg">
                  ...
                  <h3 className="font-serif text-sm font-semibold text-foreground mb-2">
                    {amenity.name}
                  </h3>
