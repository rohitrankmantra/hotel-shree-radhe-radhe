      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.03 }} className="inline-block pt-4">
          ...
          <motion.div
            ...
            className="relative grid grid-cols-3 gap-4 md:gap-6 auto-rows-[180px] lg:auto-rows-[220px]"
          >
            {featureImages.map((image, idx) => (
              <motion.div
                ...
                className={`relative rounded-2xl overflow-hidden shadow-2xl bg-muted/40 group ${
                  image.className || ""
                }`}
              >
                {/* IMAGE */}
                ...
                <div className="absolute bottom-3 left-3 right-3 text-white opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-3 group-hover:translate-y-0">
                  <p className="text-xs md:text-sm font-medium drop-shadow-lg">
                    {image.alt}
                  </p>
                </div>
              </motion.div>
